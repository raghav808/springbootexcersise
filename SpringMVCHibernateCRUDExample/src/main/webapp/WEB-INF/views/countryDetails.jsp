	...
	<form:form method="post" modelAttribute="country"
		...
		<table>
			...
			<tr>
				...
				<td><form:input path="countryName" size="30" maxlength="30"></form:input>
					<form:errors path="countryName" cssClass="error" /></td>
			</tr>
			<tr>
				<td><form:label path="population">Population:</form:label></td>
				<td><form:input path="population" size="30" maxlength="30"></form:input>
					<form:errors path="population" cssClass="error" /></td>
			</tr>
			<tr>
